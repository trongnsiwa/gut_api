...
public class ProductController {
  ...
  public ResponseEntity<ResponseDTO> addProductToCategory(
      ...
      @PathVariable("categoryId") @Min(1) Long categoryId) throws CreateDataFailException {
    ResponseDTO response = new ResponseDTO();
    try {
  ...
  public ResponseEntity<ResponseDTO> updateProduct(
      ...
      @PathVariable("categoryId") @Min(1) Long categoryId) throws UpdateDataFailException {
    ResponseDTO response = new ResponseDTO();
    try {
  ...
  public ResponseEntity<ResponseDTO> replaceImagesOfProduct(
      @Valid @RequestBody ImageListDTO imageListDTO, @PathVariable("id") @Min(1) Long id) throws UpdateDataFailException {
    ResponseDTO response = new ResponseDTO();
    try {
