...
public class UserServiceTest {
        ...
        public void setUp() {
                ...
                when(userRepository
                                .findById(UUID.fromString("628c6f73-459c-4c8d-afa5-6345b28f80ef")))
        ...
        public void testGetUsersPerPageSortByNameAscSuccess() throws LoadDataFailException {
                ...
                Page<User> expectedUser =
                                new PageImpl<User>(expected, pageRequest, expected.size());
        ...
        public void testGetUserProfileByIdSuccess() {
                assertNotNull(userService
                                .getUserProfileById(UUID.fromString(
                                                "628c6f73-459c-4c8d-afa5-6345b28f80ef")));
        }
        ...
        public void testDeleteUserSuccess() throws Exception {
                assertEquals(true,
                                userService.deleteUser(UUID.fromString(
                                                "628c6f73-459c-4c8d-afa5-6345b28f80ef")));
        }
        ...
        public void testDeactiveUserSuccess() throws Exception {
                assertEquals("INACTIVE",
                                userService.deactivateUser(UUID
                                                .fromString("628c6f73-459c-4c8d-afa5-6345b28f80ef"))
                                                .getStatus());
        }
        ...
        public void testChangeUserRolesSuccess() throws Exception {
                ...
                assertEquals(2, userService
                                .changeUserRoles(UUID.fromString(
                                                "628c6f73-459c-4c8d-afa5-6345b28f80ef"), roles)
                                .getRoles().size());
        }
        ...
        public void testChangeUserRolesFail() throws Exception {
                ...
                assertThrows(DataNotFoundException.class, () -> userService.changeUserRoles(
                                UUID.fromString("628c6f73-459c-4c8d-afa5-6345b2880ef"), roles));
        }
